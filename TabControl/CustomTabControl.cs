    ...
    public class CustomTabControl : System.Windows.Forms.TabControl
    {
        ...
        public int ActiveIndex
        {
            get
            {
                ...
                var index =
                    NativeMethods.SendMessage(Handle, NativeMethods.TCM_HITTEST, IntPtr.Zero,
        ...
        public void ShowTab(string key)
        {
            if (_TabPages != null)
            {
                var tab =
                    _TabPages.Find(
                        delegate(TabPage page) { return page.Name.Equals(key, StringComparison.OrdinalIgnoreCase); });
                ShowTab(tab);
            }
        }
        ...
        private void CustomPaint(Graphics screenGraphics)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                if (TabCount > 0)
                {
                    ...
                    {
                        _TabBufferGraphics.Clip =
                            new Region(new RectangleF(ClientRectangle.X + 3, ClientRectangle.Y,
            ...
            if (Alignment <= TabAlignment.Bottom)
            {
                if ((_StyleProvider.ImageAlign & NativeMethods.AnyLeftAlign) != (0))
                {
                    imageRect = new Rectangle((int) rect.X,
                                              (int) rect.Y + (int) Math.Floor((double) ((int) rect.Height - 16)/2), 16,
                                              16);
            ...
            else
            {
                ...
                else if ((_StyleProvider.ImageAlign & NativeMethods.AnyCenterAlign) != (0))
                {
                    imageRect = new Rectangle((int) rect.X + (int) Math.Floor((double) ((int) rect.Width - 16)/2),
                                              ...
                                              (int)
                                              Math.Floor(
                                                  (double) (((int) rect.Bottom - (int) rect.Y - (int) rect.Width + 2)/2)),
                                              16, 16);
                }
                else
                {
                ...
                if (Alignment <= TabAlignment.Bottom)
                {
                    if (RightToLeftLayout)
                    {
                        closerRect = new Rectangle((int) rect.Left,
                                                   (int) rect.Y + (int) Math.Floor((double) ((int) rect.Height - 6)/2),
                                                   6, 6);
